<%@ WebHandler Language="C#" Class="gbook_list" %>
...
public class gbook_list : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //sql语句
        string sql= "select * from guestbook order by id offset "+(pageIndex - 1)*pageSize+" rows fetch next "+pageSize+" rows only";
        string sqlAll = "select * from guestbook order by id";
