        ...
        success: function (res) {
            ...
            if (res.data === undefined) {
                ...
                outStr = "<div class=\"newsview\">" +
                    "<h3 class=\"news_title\">" + res.data[0].d_title + "</h3>" +
                    "<div class=\"bloginfo\" >" +
                    "<ul>" +
                    "<li class=\"timer\">时间：" + res.data[0].d_time + "</li>" +
                    "</ul>" +
                    "</div >" +
                    "<div class=\"news_con\">" + res.data[0].d_info + "</div>" +
                    "</div>" +
                    "<div class=\"share\" >" +
